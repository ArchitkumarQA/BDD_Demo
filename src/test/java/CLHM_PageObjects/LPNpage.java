...
public class LPNpage extends Base {
	...
	public String validate_LPNPage()
	{
	...
	public String validate_if_activity_added()
	{
		String s8 = driver.findElement(By.xpath("//span[contains(text(),'CLHW Example True/False')]")).getText();
		return s8;
	}
